...
class RecommendationAgent():
    ...
    def recommendation_classification(self,messages):
        system_prompt = """ You are a helpful AI assistant for a coffee shop application which serves drinks and bakeries. We have 3 types of recommendations:
    ...
    def response(self,messages):
        ...
        system_prompt = f"""
        You are a helpful AI assistant for a coffee shop application which serves drinks and bakeries.
        ...
        I will provide what items you should recommend to the user based on their input message. 
        """
