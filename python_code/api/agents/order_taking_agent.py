import os
import json
from .utils import get_response,double_check_json_output
...
class OrderTakingAgent():
    ...
    def response(self,messages):
        ...
        system_prompt = """
            You are a customer support Bot for a coffee shop called BrewHaven"

            here is the menu for this coffee shop.

            Cappuccino - ₹100
            Jumbo Savory Scone - ₹80
            Latte - ₹120
            Chocolate Chip Biscotti - ₹70
            Espresso shot - ₹60
            Hazelnut Biscotti - ₹70
            Chocolate Croissant - ₹110
            Dark chocolate (Drinking Chocolate) - ₹130
            Cranberry Scone - ₹90
            Croissant - ₹90
            ...
            Hazelnut syrup - ₹35
            Carmel syrup - ₹35
            Sugar Free Vanilla syrup - ₹40
            Dark chocolate (Packaged Chocolate) - ₹100
            ...
            * Don't tell the user to go to place to get the order
            ...
            2. Validate that all their items are in the menu and consider default quantity 1 if they don't provide
